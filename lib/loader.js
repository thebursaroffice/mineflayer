...
function createBot (options = {}) {
  ...
  // Preserve '1.21.11' before minecraft-data normalizes it
  const originalVersion = options.version === '1.21.11' ? '1.21.11' : null
  ...
  function next () {
    ...
    // Restore '1.21.11' if it was preserved before normalization
    bot.version = originalVersion || versionData.minecraftVersion
    options.version = originalVersion || versionData.minecraftVersion
